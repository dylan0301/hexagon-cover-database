...
separate inside the BC path theorem, but the gap count no longer changes
the point construction. Optional A and the four-point B refinement are
retained in Appendix D, outside the minimum proof route.
