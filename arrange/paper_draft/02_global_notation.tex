...
The notation used throughout the proof is summarized here.
The notation in this section is authoritative throughout the paper.  Any compatibility aliases appearing in authenticated exact-cell material are subordinate to this interface.
  Every local
...
$U_C,U_i$&the open C triangle and the open V triangle containing
$V_i$\\
$T_C,T_i$&the closures of $U_C,U_i$\\
$\CEzero,\CEone,\CEtwo$&the three C triangle types, according to the
number of positive-length boundary traces\\
$\Vdzero,\Vdone,\Vdtwo,\Tlike$&the four V triangle types determined by
...
$\Nsp$&the number of V triangles of type $\Vdone,\Vdtwo,$ or $\Tlike$\\
...
$M_0(a)=(-a+\sqrt{4-3a^2})/2$&the raw zero-radial forward envelope\\
...
notation $M_0(a)$ denotes the zero-radial envelope.
