\section{Geometric setup and structural reductions}
...
\begin{figure}[H]
\centering
\input{figures/handoff_and_gap}
\caption{One-dimensional trace model; only the drawn lengths are schematic.
The top panel shows a strict handoff in the overlap
$(1-A_{i+1},B_i)$.  The bottom panel shows the closed gap
$[B_i,1-A_{i+1}]$; when its endpoints coincide, the resulting singleton is
still uncovered by the two open traces.}
\label{fig:handoff-gap}
\end{figure}
