...
Panels (a)--(b) appear immediately after
Definition~\ref{def:body-center-assisted-transfer}.  The remaining figures
below place the reader-facing transfer and signed-center objects on the regular
hexagon skeleton.  Dashed extremal segments are not actual traces, and panels
marked schematic record incidence and order rather than metric placement.
Exact admissible-set and signed-center equations are intentionally kept in
Appendices~\ref{sec:admissible-set-derivation} and
