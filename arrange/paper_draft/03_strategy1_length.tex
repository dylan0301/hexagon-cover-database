...
If a V triangle has $A_i+B_i\le1$ and no positive-length trace on either
...
at least two V triangles are supercritical, then a V triangle distinct from
...
V triangle.  Diameter one restricts this triangle to $U_{s-1}$ or $U_{s+1}$.
...
No nonincident V triangle can contain such a point either.  Hence on every
...
is Vd2 and contains a neighboring midpoint, and all other V triangles are
