...
% STATEMENTS-ONLY-REPLACE-BEGIN: trace-subadditivity
...
% STATEMENTS-ONLY-REPLACE-END: trace-subadditivity
...
% STATEMENTS-ONLY-REPLACE-BEGIN: supercritical-cell-statement
...
% STATEMENTS-ONLY-REPLACE-END: supercritical-cell-statement
...
\begin{proof}
For item (1), the CE0 open C triangle and every nonincident V triangle miss
the relative interior of each boundary edge. The two incident open V traces
therefore overlap, so $1<B_i+A_{i+1}$ on every edge. Summing contradicts
$N_+=0$.

Items (2), (4), and (5) are items (1), (2), and (3) of
