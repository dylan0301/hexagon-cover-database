...
statements used in this section are the rational interval certificate
Theorem~\ref{thm:cert-407} and the exact Bernstein certificate
Theorem~\ref{thm:cert-ce1-five-map}, both in
Appendix~\ref{app:certificates}.  All other estimates in this section are
proved analytically.  In particular, no empirical branch catalogue and no
formal root from a discarded algebraic component is used.
...
\[
\begin{gathered}
3,\ \frac{519}{200},\ \frac{603723}{280000},\
\frac{96261783}{56000000},\ \frac{9126684741}{7000000000},\\
...
$3\cdot2004^2-3471^2=207$.  The Bernstein coefficients of $-g_5'$ on
$[1/4,1/2]$ are
\[
 \frac{29}{8},\quad\frac{167}{32},\quad\frac{83}{16},\quad
 \frac{19}{4},\quad\frac92.
\]
...
\eqref{eq:ce1-suffix}.  In the remaining two-$T_+$ branch the selected
quadratic
\[
 (1-q)(q-d)=(q-p)(2-q+p)(1-d)^2
\]
gives, by substitution at trial values,
\begin{align*}
 p_1&>L_1:=(2-4A)H-(1-4A)A,\\
 p_2:=G_{1-m}(p_1)&>L_2:=(2-5m)L_1-(1-5m)m.
\end{align*}
For the first inequality the residual, divided by $p-A$, is
\[
 -16A^5+40A^4-9A^3-20A^2+9A
 +p(16A^4-40A^3+17A^2+6A-3)>0;
\]
for the second it is
\[
 -25m^5+60m^4-11m^3-25m^2+10m
 +p(25m^4-60m^3+21m^2+8m-3)>0.
\]
For row $4$, the coefficient of $p$ in the first residual is negative:
the Bernstein coefficients of its negative on $[0,1/8]$ are
\[
 3,\quad\frac{45}{16},\quad\frac{991}{384},\quad
 \frac{595}{256},\quad\frac{527}{256}.
\]
Using $p\le e(A)<2A+5A^2$, the residual is bounded below by
\[
 A(80A^5-184A^4+45A^3+55A^2-23A+3)>0;
\]
indeed $3-23A-184A^4\ge41/512$ and the omitted terms are nonnegative.

For row $3$, $X>1/2$ implies $m<w/2<1/4$.  Every selected $T_+$ input
satisfies $p_1\le13m/4$: in the high-$c$ range this follows from
$e(m)<2m/(1-2m)$, and in the low-$c$ range from the fixed-point comparison
\[
 676m^4-1352m^3+439m^2+84m-16\ge0,
\]
whose Bernstein coefficients on $[2/15,1/2]$ are
\[
 \frac{676}{50625},\quad\frac{559}{45},\quad
 \frac{26099}{1080},\quad\frac{921}{40},\quad9.
\]
The coefficient of $p$ in the second residual is negative, since its
negative has Bernstein coefficients
\[
 3,\quad\frac52,\quad\frac{57}{32},\quad
 \frac{69}{64},\quad\frac{135}{256}
\]
on $[0,1/4]$.  At $p=13m/4$ the residual is
\[
 \frac m4(225m^4-540m^3+229m^2+4m+1)>0,
\]
and the final polynomial has Bernstein coefficients
\[
 1,\quad\frac54,\quad\frac{373}{96},\quad
 \frac{435}{64},\quad\frac{2241}{256}.
\]
This proves the two displayed strict growth estimates without an omitted
branch.

Finally let $D_0=P-RA$ and
$D_h=A(4R-1)+10RA^2-\eta$.  The function
\[
 \Psi(R,A,D)=L_2-2D-3D^2
\]
is concave in $D$, and feasibility puts $D_0\le D\le D_h$.
The exact certificate Theorem~\ref{thm:cert-ce1-five-map} proves
$\Psi(D_0)>0$ and $\Psi(D_h)>0$ on the entire domain
\eqref{eq:ce1-normal-domain}.  Hence $p_2>2D+3D^2$.

We record separately the exact one-variable check $D<1/10$.  Otherwise
$A<A_*:=P-w/10$, and $D_h(A)$ is increasing because $R>1/2$.  Direct
substitution gives
\[
 \frac1{10}-D_h(A_*)=
 -\frac{k(k-2)g_8(k)}{10(k-1)^5(k+1)^5},
\]
where
\[
...
\]
The Bernstein coefficients of $-g_8$ on $[0,3/8]$ are
\[
 14,\ \frac{191}{16},\ \frac{517}{56},\ \frac{47549}{7168},\
 \frac{253507}{57344},\ \frac{1237193}{458752},\
 \frac{5443567}{3670016},\ \frac{3148355}{4194304},\
 \frac{6601025}{16777216},
\]
and on $[3/8,1/2]$ they are
\[
 \frac{6601025}{16777216},\ \frac{575445}{2097152},\
 \frac{1446371}{7340032},\ \frac{144525}{917504},\
 \frac{69247}{458752},\ \frac{9831}{57344},\
 \frac{6075}{28672},\ \frac{135}{512},\ \frac{81}{256}.
\]
All are positive, so $D_h(A_*)<1/10$, contradicting
$D\le D_h(A)<D_h(A_*)$.  Thus $D<1/10$.  The low root $e(D)$ is the
smaller root of
\[
