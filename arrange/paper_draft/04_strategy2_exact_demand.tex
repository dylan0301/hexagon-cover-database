...
The companion edge has no active gap, so $A_0+B_5\ge1$.  Since V triangle $T_0$ is
nonsupercritical, $A_0+B_0\le1$, and therefore $B_5\ge B_0\ge s$.  The exact
radial demands at the endpoint V triangles are
\[
 c_1=1-\frac{\delta}{R},
 \qquad
 c_5=1-\frac{\alpha}{W}.
...
V triangle, distinct from $T_0$ and adjacent to $T_i$, contain $M_i$.  Assume every
other vertex V triangle is nonsupercritical Vd0 and the center has no boundary trace
...
\begin{proof}
Normalize the Vd1 V triangle at $V_0$ and the supercritical V triangle at $V_1$.
