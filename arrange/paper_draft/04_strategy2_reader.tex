...
and CE2 coordinate systems.  The complete signed center proof is in
Appendix~\ref{sec:signed-ce12-reductions}; the exact admissible-set catalogue
and the remaining scalar certificates are in
...
In the high-radial range put $e(d)=\ell(1-d)$.  The selected arc has endpoints
