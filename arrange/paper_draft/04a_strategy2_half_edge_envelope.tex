\subsection{Half-edge envelopes for adjacent CE2 placements}
\label{sec:half-edge-envelope}

The adjacent CE2 placement in Section~\ref{sec:t3-vd-demand-branches} uses a
