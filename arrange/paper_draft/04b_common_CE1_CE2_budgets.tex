...
roles containing $M_s$. Thus one of the adjacent V triangles contains $M_s$ and,
...
rescuer is nonsupercritical and distinct from the two supercritical V triangles.
