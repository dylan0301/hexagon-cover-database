...
Assume the CE2 exact-$M_0$ branch, with a unique supercritical V triangle at $V_1$ and
an adjacent Vd1 V triangle at $V_0$ containing $M_1$.  Assume every other vertex V triangle
...
edge $e_{0,1}$.  Then the two special V triangles can be replaced by two open
...
Let $(A_1,B_1,C_1)$ be the actual reaches of the unique supercritical V triangle.
...
A supercritical V triangle has own-radial coordinate at most $1/2$, so the lemma
...
$c_1^{\rm req}=1-d_1^C$.  Only the center, the supercritical V triangle, and the Vd1
V triangle have positive intervals on this arm.  Open coverage at the center handoff
gives
\[
