...
\begin{itemize}
\item S2-T3: Theorem~\ref{thm:s2-pure-t3}, with objective identification in
Proposition~\ref{prop:s2-t3-objective-bridge};
...
\begin{proof}
Use Corollary~\ref{cor:s2-pure-registry} through the bridge propositions above.  The zero-gap \(N_+=1\) all-Vd0 cell remains the
