...
demand triple realized by the same role.  The nonsupercritical restriction
...
\subsection{Branchwise nonsupercritical output}
...
\[
 F_c(a)=\min\{B_c(a),1-a\}.
\]
If an actual role has reaches $(A,B,C)$ with
\[
...
\subsection{The exact high-radial map}
...
\begin{proposition}[Four-label high-radial map]
