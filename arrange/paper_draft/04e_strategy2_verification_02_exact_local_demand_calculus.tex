...
$M_c(a)\ge1-a$ for every $c\le1/2$.  This proves the displayed formula for
$\overline M_c$ and the minimum identity.

Finally, nonsupercriticality gives $B\le1-A\le1-a$, while admissibility gives
$B\le M_c(a)$.  Thus $B\le \overline M_c(a)$.
\end{proof}
...
Down-closedness gives monotonicity, while $\overline M_c(a)\le1-a$ gives
$\Phi_c(a)\ge a$.  Finally,
\[
 \Phi_c(a)\le z\iff \overline M_c(a)\ge1-z
