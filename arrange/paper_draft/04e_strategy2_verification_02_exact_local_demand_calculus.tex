...
% STATEMENTS-ONLY-REPLACE-BEGIN: strategy2-calculus-introduction
...
component is used.
% STATEMENTS-ONLY-REPLACE-END: strategy2-calculus-introduction
...
\begin{proof}
This is Lemmas~\ref{lem:reader-midpoint-threshold} and
\ref{lem:reader-raw-capped-transfer}. The equality-boundary assignment at
$c=1/2$ is retained in \eqref{eq:reader-technical-aliases}.
\end{proof}
...
\end{equation}
% STATEMENTS-ONLY-OMIT-BEGIN: strategy2-low-root-derivation
Indeed, for
\[
...
between $X$ and $(1-X)/2$.
% STATEMENTS-ONLY-OMIT-END: strategy2-low-root-derivation
