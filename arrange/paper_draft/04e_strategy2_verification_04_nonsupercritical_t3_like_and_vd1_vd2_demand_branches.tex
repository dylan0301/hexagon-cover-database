...
original open Vd0 triangle $U_i$ cannot contain $M_{i-1}$ or $M_{i+1}$.
...
normalization and reflection, $T_0$ is T3-like with
$\Haus(T_0\cap r_1)>0$.  Then the two endpoint V triangles in the isolated configuration
satisfy
\begin{equation}
