\section{Proofs of the Finite Propagation Inequalities}
\label{sec:strategy2-pure-theorems}

This section proves the inequalities stated in Appendix~\ref{sec:strategy2-optimization-problems}, with the
...
the corresponding real domain and that the geometric final quantity equals
...
\begin{corollary}[Universal pure Strategy 2 collection]
