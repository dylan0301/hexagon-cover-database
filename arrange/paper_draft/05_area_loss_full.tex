...
The second clause below is retained as an independent alternative to
\zcref{thm:reader-zero-gap-obstruction}; only the multiple-ascent clause
is needed by the unified routing table.
