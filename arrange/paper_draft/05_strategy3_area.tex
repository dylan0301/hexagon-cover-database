...
\item exactly one selected V triangle is supercritical, every role is
...
$y_i=1-x_{-i-1}$ swaps each V triangle's two coordinates and preserves both
...
$x_{p-1}=m<x_p$.  Its V triangle contains the coordinate $1-m$ and loses at least
...
$x_5=m<x_0=M$.  The supercritical V triangle loses at least $(1-m)^2$.
...
supercritical V triangles.  Lemma~\ref{lem:cyclic-area-loss} makes the six vertex
