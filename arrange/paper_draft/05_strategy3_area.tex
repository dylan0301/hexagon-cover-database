...
% STATEMENTS-ONLY-REPLACE-BEGIN: area-details-introduction
This section proves the local inequalities and cyclic estimates used in the
area-loss argument.
% STATEMENTS-ONLY-REPLACE-END: area-details-introduction
...
\end{minipage}
% STATEMENTS-ONLY-REPLACE-BEGIN: area-figure-caption
...
% STATEMENTS-ONLY-REPLACE-END: area-figure-caption
\label{fig:area-loss}
\end{figure}
...
trace.  If the six V triangles missed a boundary point, openness of $U_C$
would give such a trace.  Hence the V triangles cover
