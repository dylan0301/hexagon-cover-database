\section{The Direct Nine-Point Obstruction}
\label{sec:ab-core}
...
forced into the center role.  Only the unique supercritical V triangle uses an
...
Assume the six vertex roles cover $\partial H$ and exactly one actual V triangle is
...
$x_4$ the global maximum.  The two anchors of V triangle $4$ lie in its open role;
