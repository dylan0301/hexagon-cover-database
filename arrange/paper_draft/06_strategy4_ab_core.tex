\section{Technical nine-point construction and enclosure}
\label{app:strategy4-details}

This appendix supplies the exact frontier, witness, sign, and cap-overlap
calculations used by the geometric narrative in Section~\ref{sec:ab-core}.
...
Appendix~\ref{app:exact-mixed-overlap} factors the two mixed Gram residuals
