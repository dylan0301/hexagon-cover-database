...
integer-polynomial signs and verified by global Bernstein identities in
...
Table~\ref{tab:routing}, for every center class.  The center-independent
obstruction is Theorem~\ref{thm:zero-gap-obstruction} in
Section~\ref{sec:ab-core}.  In CE0, a missed boundary point would create a
positive center trace, so zero gaps are automatic.  In CE1 or CE2, zero gaps
say directly that the six vertex roles cover $\partial H$.
Proposition~\ref{prop:ab-core-branches} makes these two applications explicit.
