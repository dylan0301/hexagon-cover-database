...
Assume throughout that all six V triangles are $\Vdzero$, that they
...
\[
 ...
 \qquad 0\le i\le5,
\]
are excluded from every V triangle.  Therefore they lie in $U_C$, and
convexity gives
\begin{equation}
...
V triangles, and frontier membership excludes $T_4$.  Hence
\begin{equation}
 Q_-,Q_0,Q_+\in U_C.
...
\begin{proof}
In the CE0 case, the six V triangles must cover the perimeter, since any
