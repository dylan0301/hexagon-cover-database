...
All paths below are relative to the Method~4 computation directory.
The machine-readable provenance manifest stores the full Git blob identities;
the paper prints compact identifiers and twelve-character prefixes.

\begin{center}
\scriptsize
\renewcommand{\arraystretch}{1.08}
\begin{tabular}{@{}p{.47\textwidth}p{.25\textwidth}@{}}
\toprule
certificate object&blob prefix\\
\midrule
\texttt{core\_data\_00}&\texttt{359b219f9ded}\\
\texttt{core\_data\_01}&\texttt{bfc807f90635}\\
\texttt{core\_data\_02}&\texttt{92887696ef94}\\
\texttt{core\_data\_03}&\texttt{c2791a8a6add}\\
\texttt{core\_data\_04}&\texttt{7eeabecbbd17}\\
\texttt{core\_data\_05}&\texttt{d676114292e7}\\
\texttt{core\_polynomials}&\texttt{07f57b178cf7}\\
\texttt{derivation verifier}&\texttt{0a55211ae37f}\\
\texttt{positivity verifier}&\texttt{821f9a6dc750}\\
\bottomrule
\end{tabular}
\end{center}
...
formulas and compares every coefficient with the authenticated object.  The
...
the certificate tables below; every coefficient is strictly
positive.
