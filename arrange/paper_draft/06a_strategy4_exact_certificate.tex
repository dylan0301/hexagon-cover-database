...
% STATEMENTS-ONLY-REPLACE-BEGIN: strategy4-certificate-introduction
The two mixed cap overlaps in Method~4 are certified by exact symbolic
arithmetic.  This section gives the mathematical reduction and verification
...
shards and both exact verifiers by full Git blob; the source ledger records
their role.  They decode to one canonical sparse-polynomial transcript with
SHA--256 digest
\begin{verbatim}
...
signs exactly.
% STATEMENTS-ONLY-REPLACE-END: strategy4-certificate-introduction
...
\end{equation}
% STATEMENTS-ONLY-REPLACE-BEGIN: strategy4-kappa-definition
Put
\[
...
\]
% STATEMENTS-ONLY-REPLACE-END: strategy4-kappa-definition
Define
\begin{equation}
...
\]
% STATEMENTS-ONLY-REPLACE-BEGIN: strategy4-certificate-target
...
% STATEMENTS-ONLY-REPLACE-END: strategy4-certificate-target
...
\]
Since $\lVert A\rVert>\bar\eta$ and $\Delta_0>0$, choose the tangent side for
which
\[
 \langle C',n_A\rangle
...
\[
 \sqrt{N_A-\bar\eta^2}\,h\Delta_0
 \ge\bar\tau N_A-\bar\eta\nu,
\]
and the common support is at least
...
% STATEMENTS-ONLY-REPLACE-BEGIN: strategy4-core-reduction-statement
...
strictly negative.
% STATEMENTS-ONLY-REPLACE-END: strategy4-core-reduction-statement

% STATEMENTS-ONLY-OMIT-BEGIN: strategy4-verifier-calculations
...
\[
\begin{array}{ll}
T:&0\le U\le U_\triangle,\quad 0\le z^2\le\mathcal P(U),\\
L_0:&0\le U\le U_\triangle,\quad \mathcal P(U)\le z^2\le\mathcal G(U),\\
L_1:&U_\triangle\le U\le U_{\max},\quad0\le z^2\le\mathcal G(U).
\end{array}
\]
For the $T$ cell use
\[
...
% STATEMENTS-ONLY-OMIT-END: strategy4-verifier-calculations
...
% STATEMENTS-ONLY-REPLACE-BEGIN: strategy4-certificate-remark-heading
\begin{remark}[Reproduction]
% STATEMENTS-ONLY-REPLACE-END: strategy4-certificate-remark-heading
% STATEMENTS-ONLY-REPLACE-BEGIN: strategy4-certificate-availability
...
% STATEMENTS-ONLY-REPLACE-END: strategy4-certificate-availability
\end{remark}

% STATEMENTS-ONLY-OMIT-BEGIN: strategy4-provenance-comments
...
% STATEMENTS-ONLY-OMIT-END: strategy4-provenance-comments
