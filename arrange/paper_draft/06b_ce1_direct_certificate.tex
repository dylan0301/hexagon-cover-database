...
The CE1 part of the seven-point enclosure theorem requires one longer
direct calculation.  We state the exact interface separately: only five
boundary handoffs and the three transverse radial reaches at $T_4,T_3,T_2$
are used.
