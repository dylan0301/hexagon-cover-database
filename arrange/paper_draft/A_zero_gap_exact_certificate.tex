\section{Exact Disk-Tangent Residual Certificate}
...
certified by exact symbolic arithmetic.  This section gives the mathematical reduction and verification
algorithms. The finite sparse data and the two exact programs form the
\href{https://github.com/dylan0301/hexagon-cover-database/tree/56be06718a674bda1779ee6ed30d8571217f06cd/proof/3XXX_CE0/31XX_Nplus1/310X_all_Vd0/3105X_self_contained_direct_Vd0_nine_point/3105X_computation}{electronic appendix at an immutable revision};
...
\begin{lemma}[Residual signs imply the actual-radius tangent bounds]
...
reflection supplies $z\le0$.  Lemma~\ref{lem:paper-residual-to-tangency} then
