...
The output consists of six actual nonsupercritical V triangles and
still covers the skeleton with the original C triangle fixed. It therefore
contradicts \zcref{thm:fixed-nzero}. That theorem handles all three possible
output gap ranks internally; no equality with the input rank is asserted.
The two vertex charts and every strict preservation inequality above are
unchanged.
\end{proof}
