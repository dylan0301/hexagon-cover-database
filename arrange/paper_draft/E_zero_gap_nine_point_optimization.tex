...
This appendix proves the frontier construction, witness exclusions, and
four-contact enclosure bound for the zero-gap obstruction. It also introduces
inner comparison points for the exact certificate, without changing the
three frontier witnesses $Q_-,Q_0,Q_+$.
...
\begin{equation}
 ...
 \label{eq:ab-union}
\end{equation}
By the wedge reduction, the global union from the body is
$\Psi_4(\mathcal R_{AB}^{\rm loc}(b,a))$; its two anchor parameters are exchanged.
...
Applying Theorem~\ref{thm:strict-ab-union} with the exchanged pair $(b,a)$,
...
Together with \zcref{lem:symmetric-core-witness}, this proves the
containment $K_{\rm wit}(a,b)\subset U_C$ used in the body.
