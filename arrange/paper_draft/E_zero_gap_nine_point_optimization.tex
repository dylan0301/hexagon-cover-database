...
support-arc calculations for the zero-gap nine-point obstruction.  It uses
...
\end{equation}
Assume that every $T_i=\overline{U_i}$ is $\Vdzero$ and that
...
V triangles.  Thus no V triangle contains $D_i$.  The point lies in
