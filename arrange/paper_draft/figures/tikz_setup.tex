...
\tikzset{
  ...
  actualreach/.style={draw=VertexOrange,line width=1.25pt},
  centertrace/.style={draw=CenterBlue,line width=1.25pt},
  dimline/.style={{Latex[length=1.4mm]}-{Latex[length=1.4mm]},
    draw=black!55,line width=.55pt},
  boundcurve/.style={draw=DemandRed,line width=1pt},
  transfercurve/.style={draw=RadialTeal,dashed,line width=1pt},
  inactive/.style={draw=black!38,dashed,line width=.65pt},
  ...
  atlasbox/.style={draw=black!25,rounded corners=1.5pt,inner sep=2pt}
}
