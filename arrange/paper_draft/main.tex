...
interval residuals, boundary-path budgets, and the selected high-sheet curve
used throughout the proof. The terminal mixed-overlap signs are certified by
exact rational reductions and computer-verified global Bernstein identities,
with no interval subdivision or branch-and-bound.
\end{abstract}
