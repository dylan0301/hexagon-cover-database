...
radial demands; normalized area loss; and a center-independent residual-core
obstruction based on exact $AB$-unions.  The machine-assisted steps are
stated as finite, independently checkable interval certificates with directed
...
\input{06_strategy4_nonbranching_completion}
