\subsection{Actual-gap atlas}
\label{subsec:trace-exact-ab-atlas}

The following figures illustrate the normalized nonzero-gap cases in
Table~\ref{tab:readable-finite-dispatch}.
...
\begin{figure}[p]
\centering
\includegraphics[width=.72\linewidth]{figures/trace_exact_ab/one_gap_n0_vd0.png}
\caption{Trace-exact AB-envelope snapshot: one gap, all Vd0, no
supercritical role.  The zero-gap row is intentionally omitted from this
actual-gap atlas and is illustrated by the original nine-point figure in
Chapter~\ref{sec:zero-gap-nine-point}.}
