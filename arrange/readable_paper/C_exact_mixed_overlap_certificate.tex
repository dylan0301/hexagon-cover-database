\section{Exact Unequal-Radius Support-Arc Intersections for the Zero-Gap Terminal}
\label{sec:strategy4-exact-certificate}

The two mixed cap overlaps in the zero-gap Method~3 terminal are certified by exact symbolic
...
Retain the notation of Chapter~\ref{sec:zero-gap-nine-point}.  Thus
\[
