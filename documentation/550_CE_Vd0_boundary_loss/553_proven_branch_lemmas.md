...
For $1<r<10$, the corrected interval verifier `experiments/ce_vd0_boundary_loss/attempt_interval_L_Tplus_loss_exact_corrected.py` uses the exact loss equation
