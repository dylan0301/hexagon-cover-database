...
`../800_computation/807_maximal_half_skeleton_search.md` and
`../800_computation/808_maximal_C_triangle_search.md`.
...
`../800_computation/809_symbolic_certificate_format.md` and the numerical
evidence policy in `../800_computation/810_numerical_evidence_policy.md`.

## Relation to other strategies

This strategy is complementary to the area-conjecture route in
`../640_area_conjecture/`, which also studies the case with at least two
