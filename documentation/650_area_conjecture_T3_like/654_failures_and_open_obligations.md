...
This file records what the `650_area_conjecture_T3_like` package does not prove,
...
certificate in `../640_area_conjecture/647_CE0_conditional_area_certificate.md`.
...
The two-supercritical CE0 certificate in `../640_area_conjecture/647_CE0_conditional_area_certificate.md`
