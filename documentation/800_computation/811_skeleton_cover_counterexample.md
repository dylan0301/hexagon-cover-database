...
`../../computations/20260524_skeleton_cover/counterexample_cover.json`.
The independent local verifier is
`../../computations/20260524_skeleton_cover/verify_skeleton_cover.py`.
...
```bash
python computations/20260524_skeleton_cover/verify_skeleton_cover.py
```
...
```bash
python computations/20260524_skeleton_cover/verify_skeleton_cover.py --expect-failure --drop-triangle C
```
