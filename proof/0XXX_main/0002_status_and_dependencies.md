...
| 3: finite enclosure | [`2610`](../2XXX_geometric_lemmas/26XX_enclosing_triangle_tools/2610_finite_enclosure_terminal_interfaces.md) | Proven | `2608`, `2609`, `4013_new`, `4070_new`, `4102`, `4103`, `4130_new`, `414X`, `3105X` |
...
| transverse one-gap return | `2610` Terminal C | `4102`, `4103` |
| supported rescuer tail | `2610` Terminal D | `2609`, `4130_new`, `4143` |
| residual radial separation | `2610` Terminal E | `4144`, `4146` |
...
invoke the named row of `2531` instead of repeating the same arithmetic. The
corrected Vd1 two-chart replacement remains a router and recomputes its output
gap rank.
