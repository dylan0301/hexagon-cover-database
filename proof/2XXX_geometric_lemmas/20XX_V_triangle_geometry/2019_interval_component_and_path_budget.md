...
If $1-q>e_J(p)$, every point in the nonempty interval
...
which is equivalent to the conclusion. Equality is retained for closed role
triangles; strictness for original open traces is supplied separately by the
strict-handoff theorem.
