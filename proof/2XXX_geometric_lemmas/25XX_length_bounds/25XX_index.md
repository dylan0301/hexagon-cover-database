...
This block records the proved length bounds and the direct
$N_++N_{\rm sp}$ preprocessing used by the CE branches.

| File | Recorded status | Notes |
|---|---|---|
| [`2500_boundary_length_bounds.md`](2500_boundary_length_bounds.md) | Proven | Full boundary-trace bounds for C and V triangles. |
