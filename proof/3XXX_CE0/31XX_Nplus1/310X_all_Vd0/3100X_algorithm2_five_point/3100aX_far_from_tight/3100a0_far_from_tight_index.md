...
| [`3100a6_algorithm2_two_variable_transition.md`](3100a6_algorithm2_two_variable_transition.md) | Proven | Algorithm-2 two-variable model, transition polynomial, diagonal-radius monotonicity, and limit failure. |
