...
| [`3100a6_algorithm2_two_variable_transition.md`](3100a6_algorithm2_two_variable_transition.md) | Strategy | Exact two-variable reduction; radial branch selection and transition need a finite-support proof. |
