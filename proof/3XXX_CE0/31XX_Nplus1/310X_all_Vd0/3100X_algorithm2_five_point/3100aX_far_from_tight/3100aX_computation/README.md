...
| `verify_strict_branch_line_identities.py` | SymPy checks for algebraic identities used in [`../3100a5_strict_branch_line_realization.md`](../3100a5_strict_branch_line_realization.md). | Helper for a proven local lemma. |
...
| `verify_transition_strip_certificate_arithmetic.py` | Checks that the recorded endpoint and curvature constants in [`../3100a9_algorithm2_transition_strip_certificate.md`](../3100a9_algorithm2_transition_strip_certificate.md) imply positive interpolation margins. | Verifies only the arithmetic layer of the certificate outline. |
