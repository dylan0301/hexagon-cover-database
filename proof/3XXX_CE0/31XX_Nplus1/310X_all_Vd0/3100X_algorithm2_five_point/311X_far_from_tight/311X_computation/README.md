...
| `verify_strict_branch_line_identities.py` | SymPy checks for algebraic identities used in [`../3115_strict_branch_line_realization.md`](../3115_strict_branch_line_realization.md). | Helper for a proven local lemma. |
...
| `verify_transition_strip_certificate_arithmetic.py` | Checks that the recorded endpoint and curvature constants in [`../3119_algorithm2_transition_strip_certificate.md`](../3119_algorithm2_transition_strip_certificate.md) imply positive interpolation margins. | Verifies only the arithmetic layer of the certificate outline. |
...
The transition-strip proof outline still lacks a full repository-grade interval certificate. In particular, the endpoint and curvature enclosures in [`../3119_algorithm2_transition_strip_certificate.md`](../3119_algorithm2_transition_strip_certificate.md) need saved interval subdivision data or verifier code that checks them from first principles, including the selected-root branch checks for the 309 line-circle equations.
