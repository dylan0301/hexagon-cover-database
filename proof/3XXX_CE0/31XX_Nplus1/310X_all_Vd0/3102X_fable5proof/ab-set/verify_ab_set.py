"""Verification of the ab-set case tables (ab_set.md).
...
Run:  python3 verify_ab_set.py            (full suite, ~10-20 min)
      python3 verify_ab_set.py quick      (reduced)
"""
import numpy as np
import sys
...
# ----------------------------------------------------------------------
# predicates and predicted chain (the case tables of ab_set.md)
# ----------------------------------------------------------------------
