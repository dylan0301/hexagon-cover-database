...
|---|---|---|
| [`3102_algorithm2_setup_and_point_construction.md`](3102_algorithm2_setup_and_point_construction.md) | Strategy | Reduced variables, fixed $V_4$ points, and algorithm-2 diagonal points; key containment remains empirical. |
...
| [`3105_strict_branch_line_realization.md`](3105_strict_branch_line_realization.md) | Proven | Strict $\rho<1$ realization of the selected $P_3,P_5$ intersections on the two $309$ line pieces. |
| [`3106_algorithm2_two_variable_transition.md`](3106_algorithm2_two_variable_transition.md) | Proven | Algorithm-2 two-variable reduction, transition polynomial, radius monotonicity, and limit failure. |
| [`3107_algorithm1_limit_tangent_gap.md`](3107_algorithm1_limit_tangent_gap.md) | Proven | Near-limit algorithm-1 tangent coefficient satisfies $C_1\ge1/4$. |
| [`3108_convex_order_from_line_branches.md`](3108_convex_order_from_line_branches.md) | Proven | Line branches imply $s\ge u$, $v\ge t$, and convex cyclic order for the algorithm-2 five points. |
