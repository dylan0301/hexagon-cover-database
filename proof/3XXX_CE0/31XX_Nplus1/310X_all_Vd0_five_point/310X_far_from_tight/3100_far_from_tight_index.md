...
|---|---|---|
| [`../3105_strict_branch_line_realization.md`](../3105_strict_branch_line_realization.md) | Proven local lemma | Strict $\rho<1$ realization of $P_3,P_5$ on the two $309$ line pieces. |
| [`../3106_algorithm2_two_variable_transition.md`](../3106_algorithm2_two_variable_transition.md) | Proven local lemma | Algorithm-2 two-variable model, transition polynomial, and diagonal-radius monotonicity. |
| [`../3108_convex_order_from_line_branches.md`](../3108_convex_order_from_line_branches.md) | Proven local lemma | Convex cyclic order $D_0,D_1,D_2,P_3,P_5$ once line realization holds. |
