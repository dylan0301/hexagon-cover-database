...
| [`3106_algorithm2_two_variable_transition.md`](3106_algorithm2_two_variable_transition.md) | Proven | Algorithm-2 two-variable model, transition polynomial, diagonal-radius monotonicity, and limit failure. |
