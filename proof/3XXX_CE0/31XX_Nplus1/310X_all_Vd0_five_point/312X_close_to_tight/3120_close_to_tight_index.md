...
in [`3125_algorithm1_limit_tangent_gap.md`](3125_algorithm1_limit_tangent_gap.md). That file does not prove a finite-$x$ remainder estimate.
...
| [`3125_algorithm1_limit_tangent_gap.md`](3125_algorithm1_limit_tangent_gap.md) | Proven | Near-limit algorithm-1 tangent coefficient satisfies $C_1\ge1/4$. |
