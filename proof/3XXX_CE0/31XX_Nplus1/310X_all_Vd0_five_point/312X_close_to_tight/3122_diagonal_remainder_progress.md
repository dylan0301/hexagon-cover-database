...
To upgrade this file from `Practically proven` to `Proven analytic inequality`, add either the full Bernstein coefficient lists or a reproducible exact certificate for the polynomial positivity checks used above.
