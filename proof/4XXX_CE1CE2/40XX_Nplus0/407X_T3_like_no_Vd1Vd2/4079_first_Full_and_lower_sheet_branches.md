...
The midpoint exit bound in
[`407c_rigor_completion_details.md`](407c_rigor_completion_details.md),
Lemma 2.1, gives $u<1/2$, hence $1-u>0$. Thus $\lambda\ge1/2$.
...
The left lower-sheet estimates in
[`407c_rigor_completion_details.md`](407c_rigor_completion_details.md),
Lemma 2.2, give
...
For $A_1=q$, CE2 overlap gives $q>S$, and
[`407c_rigor_completion_details.md`](407c_rigor_completion_details.md),
Lemma 2.2, gives $S>\ell(y)$, contradiction. For $A_1=A_C$, we have
$A_C=\lambda(1-y)$ with $\lambda\ge1/2$, so
...
But [`407c_rigor_completion_details.md`](407c_rigor_completion_details.md),
Lemma 2.2, gives
