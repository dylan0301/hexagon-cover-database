...
The endpoint calculation and the three-row boundary budget are no longer
repeated here.
...
Thus rows $T_1,\ldots,T_5$ are nonsupercritical Vd0 rows.  Both center traces
