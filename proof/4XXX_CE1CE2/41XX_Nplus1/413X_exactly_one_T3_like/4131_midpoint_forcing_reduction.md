...
so the unique supercritical V triangle is a different V triangle. The exhaustive
...
shows that the remaining four nonsupercritical, non-T3-like V triangles are Vd0 V triangles.
...
2. A T3-like V triangle $T_i$ does not contain $M_i$.
3. A supercritical V triangle contains none of its three local midpoints.
4. A Vd0 V triangle has no positive-length adjacent-ray intersection and therefore
   cannot cover an adjacent midpoint.
5. In the present midpoint-forcing branch, each Vd0 V triangle covers its own
   midpoint.

Then, after possibly reflecting across the axis through $O$ and $V_0$,

$$
\boxed{T_0\text{ is the unique T3-like V triangle, }M_1\in T_0,\text{ and }T_1
\text{ is the unique supercritical V triangle}.}
$$
...
Let $\tau$ be the index of the unique T3-like V triangle. By the T3-like midpoint
exclusion,
...
$T_\tau$, as just noted. It is not covered by the unique supercritical V triangle,
because supercritical V triangles contain no local midpoints. Finally, no Vd0 V triangle can
cover $M_\tau$ unless it is the V triangle based at $V_\tau$, because a Vd0 V triangle
cannot cover an adjacent midpoint; but the V triangle based at $V_\tau$ is the
T3-like V triangle, not a Vd0 V triangle. Hence $M_\tau$ would be uncovered, contradicting
...
Thus $T_0$ is the unique T3-like V triangle.

Let $\sigma$ be the index of the unique supercritical V triangle. Since $T_0$ is
T3-like and T3-like V triangles are nonsupercritical, $\sigma\ne0$.
...
not local to $T_0$. As before, no Vd0 V triangle can rescue an adjacent midpoint, and
every non-supercritical non-T3-like V triangle in this branch is Vd0. Thus
...
If $\sigma=1$, then $M_1$ cannot be covered by $T_C$, $T_1$, or any Vd0 V triangle.
...
The four remaining V triangles are neither supercritical nor T3-like, and by the
branch assumption no V triangle is Vd1 or Vd2. Hence they are Vd0 V triangles. Since they
