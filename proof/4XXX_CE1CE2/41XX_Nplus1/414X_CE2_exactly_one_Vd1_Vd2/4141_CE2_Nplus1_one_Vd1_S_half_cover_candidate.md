...
![CE2, $N_+=1$, one-Vd1 $S_{1/2}$ cover candidate](figures/4140_CE2_Nplus1_one_Vd1_S_half_candidate_cover.webp)
...
$S_{1/2}$, $S$, $H$, or $H_L$, and it does not change the `Reduction` status of
