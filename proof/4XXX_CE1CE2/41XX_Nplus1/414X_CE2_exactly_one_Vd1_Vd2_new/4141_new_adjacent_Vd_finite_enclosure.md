...
for two gaps. The adjacent Vd residual and one-third estimates below
are retained alternatives, not a separate active E family. See [`2612`](../../../2XXX_geometric_lemmas/26XX_enclosing_triangle_tools/2612_fixed_witness_unification.md) for the fixed-set construction and the
