...
```bash
python proof/800_computation/20260524_skeleton_cover/verify_skeleton_cover.py
```

Negative self-check:

```bash
python proof/800_computation/20260524_skeleton_cover/verify_skeleton_cover.py --expect-failure --drop-triangle C
```
