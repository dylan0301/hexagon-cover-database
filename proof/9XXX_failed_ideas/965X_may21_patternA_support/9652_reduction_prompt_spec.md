...
Historical context: the original global target was to prove that seven open equilateral triangles of side length $1$ cannot cover $S$. The May 24, 2026 counterexample in `../908X_skeleton_cover_counterexample/9081_skeleton_cover_counterexample.md` refutes this as a standalone target. This file only records the May 21/22 focused reduction target.
...
For the candidate nondegenerate strict frontier formula, with its two
unit-circle arcs and two line segments, see
